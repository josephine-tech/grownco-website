          ...
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div className="w-5 h-5 relative flex-shrink-0">
              <svg viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                ...
                />
                <path
                  d="M14 24V12M14 12C14 12 10 10 8 7"
                  stroke="#FAFAF7"
                  strokeWidth="1.2"
                  strokeLinecap="round"
                  opacity="0.7"
          ...
          <nav className="hidden md:flex items-center gap-8">
            {links.map(({ href, label }) => (
              <Link
                key={href}
                href={href}
                className="relative font-display text-base font-medium text-text-primary hover:text-gold transition-colors duration-200 group"
              >
                {label}
                <span
